...
function ScenesQuery({ className, onUpdate }) {
    ...
    <Card className={className + " p-3"} shadow={false}>
      <div className="flex flex-col gap-3">
        ...
        <Typography variant="small" color="blue-gray" className="opacity-70">
          Text query is required and must be in English. Top K must be at least 16 and at most 1024 due to system limitations.
        </Typography>
      </div>
    </Card>
  );
...
export default memo(ScenesQuery);
